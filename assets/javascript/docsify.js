...
Compiler.prototype._initRenderer = function _initRenderer () {
  ...
  origin.link = renderer.link = function (href, title, text) {
    ...
    if (href.endsWith(".hex"))
    {
      ...
      return '<a class=\"input-reset hover-bg-black w-100 tracked-mega bg-black-70 b--black-10 white f6 pv2 pv2-ns ph4 ba b--black-80 bg-hover-mid-gray fontbit\" onclick="window.downloadHex(this)\" value=\"' + href + '\" programname=\"' + text + '\">INSTALL</a>';
