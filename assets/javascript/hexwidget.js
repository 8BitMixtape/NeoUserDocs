$(function () {
      ...
      window.openModal = function (hex_id, hex_name)
      {
          vex.dialog.open({
            ...
            input: ' <a class="pure-button" onclick="window.uploadHexBtn(this, event);" href="#" value="' + hex_id + '" ><span class="fa fa-bolt icon-spacer"></span><b>INSTALL ' + hex_name + '</b> <span class="fa fa-bolt icon-spacer"></span></a>'
        });
      }
